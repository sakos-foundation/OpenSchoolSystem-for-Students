...
<body>
	<div id="notfound">
		<div class="notfound">
			...
			<h2>Tato metoda není implementována.</h2> Může se jednat o dočasný výpadek, zkuste stránku načíst znovu později. Pokud problém přetrvává, kontaktujte Administraci Výpisků.<br>
